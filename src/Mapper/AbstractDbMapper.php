...
abstract class AbstractDbMapper extends EventProvider
{
    ...
    /**
     * @param Select $select
     * @param UserRoleLinkerInterface|null $entityPrototype
     * @param HydratorInterface|null $hydrator
     * @return HydratingResultSet
     */
    protected function select(Select $select, UserRoleLinkerInterface $entityPrototype = null, HydratorInterface $hydrator = null)
    {
        $this->initialize();
     ...
     */
    protected function insert(UserRoleLinkerInterface $entity, $tableName = null, HydratorInterface $hydrator = null)
    {
        $this->initialize();
     ...
     * @return ResultInterface
     */
    protected function update(UserRoleLinkerInterface $entity, $where, $tableName = null, HydratorInterface $hydrator = null)
    {
        $this->initialize();
        $tableName = $tableName ?: $this->tableName;
        $sql = $this->getSql()->setTable($tableName);
    ...
    /**
     * @param UserRoleLinkerInterface $entityPrototype
     * @return AbstractDbMapper
     */
    public function setEntityPrototype(UserRoleLinkerInterface $entityPrototype)
    {
     ...
     * @return array
     */
    protected function entityToArray(UserRoleLinkerInterface $entity, HydratorInterface $hydrator = null)
    {
        if (!$hydrator) {
            $hydrator = $this->getHydrator();
        }
